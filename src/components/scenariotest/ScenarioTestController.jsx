...
export default function ScenarioTestController(props) {
  ...
  const handleActivityChange = (event, index) => {
    let selectedActivity = allActivities.find(
  ...
  const handleLoadDesignChange = (event, index) => {
    let loadVariant = allLoadDesigns.find(
  ...
  const handleResilienceDesignChange = (event, index) => {
    let resilienceVariant = allResilienceDesigns.find(
      (variant) => variant.name === event.target.value
    );
  ...
  const filterAllActivityScenarios = (event) => {
    ...
    let result = ScenarioTestApplicationService.filterAllScenarios(
                            ...
                            return (
                              <>
                                <input
                                  ...
                                  name={
                                    "Response Measure Option: Index" + index
                                  }
                            ...
                            return (
                              <>
                                <input
                                  ...
                                  name={
                                    "Response Measure Expected: Index" + index
                                  }
                              ...
                              return (
                                <>
                                  ...
                                  scenario.load_design?.name
                                    ? loadVariant.design_parameters != null &&
                              ...
                              return (
                                <>
                                  ...
                                  scenario.resilience_design?.name
                                    ? resilienceVariant.design_parameters !=
                                        null &&
