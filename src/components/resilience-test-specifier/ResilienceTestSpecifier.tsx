...
export function ResilienceTestSpecifier({
  ...
  const [resilienceTest, setResilienceTest] =
    useState<ResilienceTestDefinition>({
    ...
    <div className="p-4 prose h-full overflow-auto bg-slate-200 ">
      ...
      <InputSelect
        ...
        options={getActivitiesForSystem(
          domain,
          resilienceTest.artifact?.system_id
        )}
        optionName={"action"}
        optionValue={"_id"}
        onChange={handleChange}
      ...
      <InputSelect
        ...
        name={"stimulus.type"}
        value={
          "type" in resilienceTest.stimulus && resilienceTest.stimulus.type
        }
