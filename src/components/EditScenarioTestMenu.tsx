...
// 		const relatedEdgesArray = reactFlowInstance
// 			.getEdges()
// 			.filter((edge) => edge.name == e.target.value);
// 		const unrelatedEdgesArray = reactFlowInstance
// 			.getEdges()
// 			.filter((edge) => edge.name != e.target.value);
...
// 		const newEdgesArray = relatedEdgesArray.concat(unrelatedEdgesArray);
...
// 			rqa.runtime_quality_analysis.artifacts.findIndex(
...
// 		const loadVariant = allRqs.loadDesign.find(
...
// 		const copyDesignParameter = deepCopy(loadDesign.designParameters[index]);
// 		copyDesignParameter.value = value;
// 		const newLoadDesign = deepCopy(loadDesign);
...
// 		const resilienceVariant = allRqs.resilienceDesign.find(
// 			(variant) => variant.name === e.target.value,
// 		);
...
// 		const copyResilienceParameter = deepCopy(
// 			resilienceDesign.designParameters[index],
// 		);
// 		copyResilienceParameter.value = value;
// 		const newResilienceDesign = deepCopy(resilienceDesign);
...
// 		const newResponseMeasures = deepCopy(responseMeasures);
// 		const metricIndex = newResponseMeasures.findIndex(
// 			(metric) => metric.name === parameterName,
// 		);
// 		if (metricIndex === -1) {
// 			const newMetric = { name: parameterName, value: parameterValue };
